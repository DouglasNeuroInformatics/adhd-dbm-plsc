...
# ── DBM jacobian path ─────────────────────────────────────────────────────────
DBM_BASE="/home/moncia/scratch/projects/hailab_ADHD/dbm/optimized_antsMultivariateTemplateConstruction/output/dbm/jacobian/relative/smooth"
JACOBIAN_DIR="${DBM_BASE}/${ANALYSIS_NAME}"
...
MASK_FILE="${ANALYSIS_DIR}/data/mask_shapeupdate.mnc"
TEMPLATE_FILE="${ANALYSIS_DIR}/data/template_sharpen_shapeupdate.mnc"
